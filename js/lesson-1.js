...
// Розв'язок 3:
/* const num = prompt(`введіть будь-яку ціле число від 1 до 4 включно`);
let result;
switch (num) {
  case "1":
    result = "зима";
...
// Розв'язок 4:
/* const inputMinutes = Number(prompt(`Введіть число`));
...
console.log(formatTime(inputMinutes)); */
